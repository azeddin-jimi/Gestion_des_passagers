        ...
        <div class="row min-vh-100">
            <aside class="col-lg-2 px-0 bg-white border-end shadow-sm">
                <div class="p-3 border-bottom">
                    <a href="{{ route('admin.dashboard') }}" class="text-decoration-none fw-bold text-markoub d-flex align-items-center gap-2">
                        <i class="bi bi-speedometer2"></i>
                        {{ __('Admin') }}
                    </a>
                </div>
                <nav class="nav flex-column p-2 gap-1">
                    <a class="nav-link rounded {{ request()->routeIs('admin.dashboard') ? 'active bg-primary text-white' : 'text-dark' }}" href="{{ route('admin.dashboard') }}">
