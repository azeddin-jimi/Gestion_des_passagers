                    ...
                    <ul class="nav nav-pills mb-3" id="authTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="login-tab" data-bs-toggle="pill"
                                data-bs-target="#login-pane" type="button" role="tab">{{ __('Se connecter') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="register-tab" data-bs-toggle="pill" data-bs-target="#register-pane"
                                type="button" role="tab">{{ __('S\'inscrire') }}</button>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="login-pane" role="tabpanel">
                            <form method="POST" action="{{ route('login') }}" class="row g-3">
                                ...
                                @if ($errors->any() && old('_auth_tab') === 'login')
                                    <div class="col-12">
                                ...
                                <div class="col-12 d-flex justify-content-between small">
                                    ...
                                    <button type="button" class="btn btn-link p-0" data-bs-toggle="pill"
                                        data-bs-target="#register-pane">{{ __('S\'inscrire') }}</button>
                                </div>
                                <div class="col-12">
                                    <button type="submit"
                                        class="btn btn-markoub w-100 btn-animated">{{ __('Se connecter') }}</button>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="register-pane" role="tabpanel">
                            <form method="POST" action="{{ route('register') }}" class="row g-3">
                                ...
                                @if ($errors->any() && old('_auth_tab') === 'register')
                                    <div class="col-12">
                                        <div class="alert alert-danger mb-0">
                                            {{ $errors->first() }}
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="country_code">
                                        <option value="+212" {{ old('country_code') === '+212' ? 'selected' : '' }}>🇲🇦 +212
                                        </option>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="whatsapp" class="form-control" placeholder="6XXXXXXXX"
                                ...
                                <div class="col-12">
                                    <button type="submit"
                                        class="btn btn-markoub w-100 btn-animated">{{ __('S\'inscrire') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
